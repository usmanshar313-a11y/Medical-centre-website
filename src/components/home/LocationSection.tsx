...
export const LocationSection: React.FC = () => {
  ...
  return (
    <section id="location" className="py-16 bg-[#F5F1E8] text-[#0B6B4E]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12 space-y-3">
          ...
          <p className="text-xs sm:text-sm text-emerald-950/80">
            Conveniently located in Block 13, Gulberg Town, Karachi. Accessible round-the-clock for routine checkups and emergencies.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          {/* Info Card */}
          <div className="lg:col-span-5 bg-white p-6 sm:p-8 rounded-2xl shadow-md border border-emerald-900/10 flex flex-col justify-between space-y-6">
            <div className="space-y-4">
              <h3 className="font-heading font-bold text-xl text-[#0B6B4E]">
                Contact & Address
              </h3>

              <div className="space-y-4 text-xs sm:text-sm">
                <div className="flex items-start gap-3 p-3 bg-[#F5F1E8] rounded-xl">
                ...
                <div className="flex items-start gap-3 p-3 bg-[#F5F1E8] rounded-xl">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-[#D64545] font-bold hover:underline text-sm"
                    >
                      +92 21 36342011
                    </a>
                  </div>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="w-full bg-[#0B6B4E] hover:bg-[#08523c] text-white py-3 rounded-xl text-xs sm:text-sm font-bold shadow flex items-center justify-center gap-2 transition-colors"
            >
          ...
          {/* Map Embed */}
          <div className="lg:col-span-7 bg-white rounded-2xl shadow-md border border-emerald-900/10 overflow-hidden min-h-[350px]">
            <iframe
